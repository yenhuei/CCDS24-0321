...
for epoch in range(len(result1)):
    writer.add_scalars(f"Average Joules-per-kbit ",
                       {
                           f'Random Offloading': result1[epoch],
                           # f'Basic DQN LR=0.10': result2[epoch],
                           # f'Basic DQN LR=0.20': result3[epoch],
                       }, epoch+1)
    ...
    writer.add_scalars("Energy Comparison ",
                       {
                          # 'No Offloading': energy_list_no[epoch],
                           'Random Offloading': energy_list05[epoch],
                           # 'Basic DQN LR=0.10': energy_list10[epoch],
                           # 'Basic DQN LR=0.20': energy_list20[epoch],
    ...
    writer.add_scalars("Time Comparison ",
                       {
                          # 'No Offloading': time_list_no[epoch],
                            'Random Offloading': time_list05[epoch],
                            # 'Basic DQN LR=0.10': time_list10[epoch],
                            # 'Basic DQN LR=0.20': time_list20[epoch],
    ...
    writer.add_scalars("Real Energy Comparison ",
                       {
                           #'No Offloading': real_energy_list_no[epoch],
                            'Random Offloading': real_energy_list05[epoch],
                            # 'Basic DQN LR=0.10': real_energy_list10[epoch],
                            # 'Basic DQN LR=0.20': real_energy_list20[epoch],
...
#                        {
#                            'Random Offloading': sum(loss1[:epoch+1]),
#                            # 'Basic DQN LR=0.10': sum(loss2[:epoch+1]),
#                            # 'Basic DQN LR=0.20': sum(loss3[:epoch+1]),
#                        }, epoch+1)
