...
for epoch in range(len(result1)):
    writer.add_scalars("Real Average Comparison ",
                       {
                           'No Offloading': real_average_list_no[epoch],
                           'DDQN LR=0.05': real_average_list05[epoch],
                           'DDQN LR=0.10': real_average_list10[epoch],
                           'DDQN LR=0.20': real_average_list20[epoch],
                           'Full Offloading': real_average_list_full[epoch],
                       }, epoch+1)
