...
for runNumber in range(50):
    if runNumber > 0:
        df[columnName] = result1
    print(runNumber)
    ...
    for i_episode in range(num_episodes):
        ...
        for t in count():
            ...
            done = terminated = currentTask==NUM_DEVICES
            ...
            if done:
                ...
                result1.append(total_energy)
                plot_durations()
                break

print('Complete')
df[columnName] = result1
df.to_excel("DDQN.xlsx", sheet_name="Sheet2")
